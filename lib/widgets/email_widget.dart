...
class _EmailWidgetState extends State<EmailWidget> {
  ...
  Color get _surfaceColor {
    // Se a propriedade 'isPreview' do widget for 'false'...
    if (widget.isPreview == false) {
      // ...a cor será 'surface'.
      return _colorScheme.surface;
    }
    // Se a propriedade 'isSelected' do widget for 'true'...
    if (widget.isSelected == true) {
      // ...a cor será 'primaryContainer'.
          ...
          Column(
            ...
            children: [
              ...
              if (widget.isThreaded) ...[
                contentSpacer,
                Text(
                  "To ${widget.email.recipient.map((recipient) => recipient.name.first).join(", ")}",
